...
- [ ] 1.1 `docs/specs/2026-03-31-v121-operations-design.md` — line 621
      (`dotnet pack ... -o /media/Data/Source/Verbara/local-nuget-feed/` → `../local-nuget-feed/`).
- [ ] 1.2 `docs/specs/2026-04-07-sprint0-security-fixes-design.md` — lines 193, 195, 198
...
- [ ] 1.3 `docs/specs/2026-04-07-sprint1-suspension-settings-design.md` — line 286
      (`cd .../Verbara.Platform` → workspace-relative).
- [ ] 1.4 `docs/specs/2026-04-07-sprint2-features-dunning-design.md` — lines 409, 552, 554, 557
...
- [ ] 1.5 `docs/specs/2026-04-19-product-strategy-v2.md` — lines 328, 770
...
- [ ] 2.1 `docs/specs/2026-05-19-phase-d-dapper-aot-migration-design.md` — line 200 (×1)
...
- [ ] 2.2 `docs/specs/2026-05-19-phase-d-dapper-removal-raw-npgsql-design.md` — lines 137, 172,
...
- [ ] 2.3 `docs/specs/2026-05-19-verbara-sdk-dapper-stubs-design.md` — lines 324, 326, 328, 329
...
- [ ] 3.1 Add a `CHANGELOG.md` `[Unreleased]` entry recording the path-leak purge in the 8
      `docs/specs/` documents (required by the `/xr:apply` commit gate — ledger row 10).
- [ ] 3.2 `grep -rn '/media/Data/Source/' docs/specs/` returns no matches across the 8 in-scope
      files (the `tests/**` load-test transcripts stay leaked by design — out of scope).
- [ ] 3.3 `npx -y @fission-ai/openspec@1.6.0 validate --all --strict --no-interactive` — MUST pass.
