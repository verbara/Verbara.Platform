...
/// </summary>
/// <remarks>
/// Promoted from internal in <c>Asterisk.Platform.Api</c> to a public abstraction in
/// <c>Asterisk.Platform.Identity</c> so that out-of-process implementations
/// (e.g. <c>Asterisk.Platform.Identity.Redis</c>) can satisfy the contract without
