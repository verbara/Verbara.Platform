...
namespace Asterisk.Platform.Identity.DependencyInjection;
...
public static partial class PlatformDataProtectionExtensions
{
    ...
    /// </summary>
    private const string EphemeralWarningCategory = "Asterisk.Platform.Identity.DataProtection";
...
{
    /// <summary>
    /// DataProtection application name. Defaults to <c>"Asterisk.Platform"</c>.
