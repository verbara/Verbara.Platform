...
using Asterisk.Platform.Core.Impersonation;
...
///
/// Lives under <c>Asterisk.Platform.Api.Services</c> rather than
/// <c>Asterisk.Platform.Core.Impersonation</c> because <c>Core</c> intentionally
