...
namespace Asterisk.Platform.Api.DependencyInjection;
...
/// <c>AddAsteriskPlatformIdentityRedis</c> + <c>AddAuthHotpathRedisInvalidation</c>
...
public static class AuthHotpathCachingExtensions
{
    ...
    /// <c>AddAsteriskPlatformIdentityRedis</c> has been called and the
