...
echo "[1/8] Installing local-path-provisioner..."
...
echo "[2/8] Installing CloudNativePG + Postgres 3-HA..."
...
echo "[4/8] Installing Asterisk Helm chart..."
...
# --- 5. Platform.Api + Web ---
echo "[5/8] Installing Platform Helm chart..."
...
# --- 6. Observability ---
echo "[6/8] Installing observability stack..."
bash "$INFRA/helm/observability/install.sh"
echo "  Done."

# --- 7. Alert rules ---
echo "[7/8] Applying PrometheusRule CRD..."
