...
- **2026-05-09 (update — corrections from deeper Trigger 3 audit)**: A focused pre-public security review of 60 endpoints across the four Trigger 3 families (`2026-05-09-pre-public-security-review.md`) raised **2 P0 + 4 P1** findings that supersede claims made above. Specifically:
