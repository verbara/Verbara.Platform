...
**Created:** 2026-05-19 · **Status:** Approved (design) · **Supersedes:** Option O / `Verbara.Sdk.Dapper.Stubs` approach in [`docs/plans/completed/2026-05-19-phase-d-dapper-aot.md`](../plans/completed/2026-05-19-phase-d-dapper-aot.md) · **ADR:** [0022](../decisions/0022-platform-api-aot-shipping-path.md) (Amendment §8 pending) · **Owner:** Maintainer
