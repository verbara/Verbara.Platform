...
6. **Phase 6 — 24h AOT soak (optional).** Re-run the D-LK profile against the AOT image; compare to the IL baseline (p99 avg 60.66 ms, ~959M req, 0 fails, 12–13 Postgres conns sustained). Expected equal or better.
