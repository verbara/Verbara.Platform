...
**Última actualización:** 2026-05-18 · **Baselines actuales:** Platform **`2.2.0`** (SHIPPED 2026-05-18 — commit `0de22761`, tag `v2.2.0`, CI green) · Platform.Web `3.0.3-web` · SDK pin `2.1.2` · Pro pin **`2.4.0-pro`** · **🎉 visibility flip EXECUTED 2026-05-10 19:04 UTC — all 7 ADR-0018 triggers GREEN; Platform + Web repos PUBLIC; first cosign-signed images live at `ghcr.io/verbara/platform/{api,web}`** · **🎯 2026-05-17 PIVOT: Reference Deployment + manuales SMB on-premise (Fase 1) — 6 deliverables shipped (~6,300 líneas)** · **✅ 2026-05-18 SHIPPED: Platform v2.2.0 "Pro v2.4.0-pro consumer migration"** — HTTP 402 RFC 9457 contract + `GET /management/system/license/status` admin surface + SMB manuales migrated off `LICENSING_MODE` → `LICENSE_PATH` model; 32 files / +441 / -49 / 2,048 tests passing cross-package. **Pro v2.5.0-pro pre-conditions #2 + #3 MET on this ship; #1 elegible 2026-06-28+.** R5.5 cloud (Phase 0C+) deferred indefinidamente.
