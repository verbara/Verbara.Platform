...
public sealed class VerbaraCapacitySyncServiceTests : IDisposable
{
    ...
    private readonly VerbaraCapacitySyncService _sut;

    public VerbaraCapacitySyncServiceTests()
    {
        _sut = new VerbaraCapacitySyncService(
            _capacityService,
            _agentStore,
            _eventBus,
