...
/// as all other working factories) so the mock <see cref="Asterisk.Platform.Identity.IApiKeyStore"/>
...
/// <see cref="Asterisk.Platform.Api.Auth.PartnerAdminAuthorizationHandler"/> can verify the
