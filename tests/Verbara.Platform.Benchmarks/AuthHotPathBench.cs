// Verbara.Platform.Benchmarks — AHH Phase 0 evidence benchmarks.
//
...
//
// Repro: dotnet run -c Release --project tests/Verbara.Platform.Benchmarks
...
namespace Verbara.Platform.Benchmarks;
